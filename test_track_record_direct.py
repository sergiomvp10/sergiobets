...
def test_track_record_direct():
    """Test track record system directly"""
    print("=== TESTING TRACK RECORD DIRECTLY ===")
...
if __name__ == "__main__":
    success = test_track_record_direct()
    if success:
        print("\n✅ Track record direct test PASSED")
    else:
        print("\n❌ Track record direct test FAILED")
