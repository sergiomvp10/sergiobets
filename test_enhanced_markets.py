#!/usr/bin/env python3
"""Test enhanced markets: cards, handicap, and improved form analysis"""

import sys
sys.path.append('/home/ubuntu/repos/sergiobets')

from ia_bets import filtrar_apuestas_inteligentes, analizar_rendimiento_equipos
