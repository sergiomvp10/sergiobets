@echo off
echo ========================================
echo BetGeniuX Windows Compilation Script
echo ========================================
...
echo Running BetGeniuX-Console.exe for 10 seconds...
timeout /t 2 /nobreak > nul
start /wait /b dist\BetGeniuX-Console.exe &
timeout /t 10 /nobreak > nul
taskkill /f /im BetGeniuX-Console.exe > nul 2>&1
...
echo.
echo Files created:
echo - dist\BetGeniuX-Console.exe (shows console for debugging)
echo - dist\BetGeniuX.exe (no console window)
echo.
echo IMPORTANT:
echo 1. Test BetGeniuX-Console.exe first to see any errors
echo 2. Check sergiobets_debug.log for detailed logs
echo 3. If console version works, then use BetGeniuX.exe
echo.
pause
